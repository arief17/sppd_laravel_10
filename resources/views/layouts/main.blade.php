					...
					<aside class="app-sidebar sidebar-scroll">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								@can('isAdmin')
								<li class="slide {{ request()->routeIs('bidang*', 'seksi*', 'kegiatan*', 'pangkat*', 'pegawai*', 'tanda-tangan*', 'alat-angkut*', 'jabatan*', 'ketentuan*', 'user*', 'golongan*', 'area*', 'provinsi*', 'kota-kabupaten*', 'uang-harian*', 'uang-transport*', 'biaya-perdin*', 'golongan*', 'area*', 'provinsi*', 'kota-kabupaten*') ? 'is-expanded' : '' }}">
									...
									<ul class="slide-menu">
										...
										<li><a class="slide-item {{ request()->routeIs('area.index') ? 'active' : '' }}" href="{{ route('area.index') }}">Area</a></li>
										...
										<li class="sub-slide {{ request()->routeIs('uang-harian*', 'uang-transport*', 'biaya-perdin*') ? 'is-expanded' : '' }}">
