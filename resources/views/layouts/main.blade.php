					...
					<aside class="app-sidebar sidebar-scroll">
						...
						<div class="main-sidemenu">
							...
							<ul class="side-menu">
								...
								@can('isAdmin')
								<li class="slide {{ request()->routeIs('bidang*', 'seksi*', 'kegiatan*', 'pangkat*', 'pegawai*', 'tanda-tangan*', 'alat-angkut*', 'jabatan*', 'ketentuan*', 'user*', 'golongan*', 'area*', 'provinsi*', 'kota-kabupaten*', 'uang-harian*', 'uang-transport*', 'uang-penginapan*', 'biaya-perdin*', 'golongan*', 'area*', 'provinsi*', 'kota-kabupaten*') ? 'is-expanded' : '' }}">
