				...
				<form action="{{ route('tanda-tangan.show', $tanda_tangan->slug) }}" method="post">
					...
					<div class="form-group">
						...
						<select name="pegawai" id="pegawai" class="form-control form-select @error('pegawai') is-invalid @enderror">
							...
							<option value="{{ $pegawai->id }}" @selected(old('pegawai', $tanda_tangan->pegawai) == $pegawai->id)>
								{{ $pegawai->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="jabatan" id="jabatan" class="form-control form-select @error('jabatan') is-invalid @enderror">
							...
							<option value="{{ $jabatan->id }}" @selected(old('jabatan', $tanda_tangan->jabatan) == $jabatan->id)>
								{{ $jabatan->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						<div class="form-check">
							<input class="form-check-input @error('status') is-invalid @enderror" type="checkbox" name="status" value="status" id="status" @checked(old('status', $tanda_tangan->status))>
