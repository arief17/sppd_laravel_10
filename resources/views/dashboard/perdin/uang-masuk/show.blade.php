			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table mg-b-0 text-md-nowrap border-bottom">
						<tr>
							<th>Tanggal Input:</th>
							<td style="width: 90%">{{ $uang_masuk->created_at->format('d F Y') }}</td>
						</tr>
						<tr>
							<th>Tanggal Uang Keluar:</th>
							<td style="width: 90%">{{ $uang_masuk->tgl_saldo->format('d F Y') }}</td>
						</tr>
						<tr>
							<th>Keterangan:</th>
							<td style="width: 90%">{{ $uang_masuk->keterangan }}</td>
						</tr>
						<tr>
							<th>Saldo:</th>
							<td style="width: 90%">{{ number_format($uang_masuk->saldo, 0, ',', '.') }}</td>
						</tr>
					</table>
				</div>
			</div>
