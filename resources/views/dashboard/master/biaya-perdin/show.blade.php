			...
			<div class="card-body">
				<div class="table-responsive">
					<table class="table mg-b-0 text-md-nowrap border-bottom">
						<tr>
							<th>Area:</th>
							<td style="width: 90%">{{ $biaya_perdin->area->nama }}</td>
						</tr>
						<tr>
							<th>Dari:</th>
							<td style="width: 90%">{{ $biaya_perdin->dari->nama }}</td>
						</tr>
						<tr>
							<th>Ke:</th>
							<td style="width: 90%">{{ $biaya_perdin->ke->nama }}</td>
						</tr>
						<tr>
							<th>Transport:</th>
							<td style="width: 90%">{{ $biaya_perdin->transport->nama }}</td>
						</tr>
						<tr>
							<th>Harian:</th>
							<td style="width: 90%">{{ $biaya_perdin->harian->nama }}</td>
						</tr>
					</table>
				</div>
			</div>
