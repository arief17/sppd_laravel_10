			...
			<div class="card-body pt-0">
				<form action="{{ route('jenis-perdin.show', $jenis_perdin->slug) }}" method="post">
					...
					<div class="form-group">
						...
						<input name="no_rek" value="{{ old('no_rek', $jenis_perdin->no_rek) }}" type="text" class="form-control @error('no_rek') is-invalid @enderror" id="no_rek" placeholder="Masukan no_rek">
						@error('no_rek')
						<div class="invalid-feedback">
							{{ $message }}
						</div>
