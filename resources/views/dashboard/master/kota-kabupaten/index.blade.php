		...
		<div class="card">
			<div class="card-header">
				<div class="d-flex align-items-center">
					...
					<a href="{{ route('kota-kabupaten.create') }}" class="btn btn-primary mg-l-auto">Tambah</a>
				</div>
			</div>
			<div class="card-body">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a class="btn btn-info btn-sm" href="{{ route('kota-kabupaten.edit', $kota_kabupaten->slug) }}">
										<i class="fas fa-pencil-alt"></i>
										Edit
									</a>
									<form action="{{ route('kota-kabupaten.destroy', $kota_kabupaten->slug) }}" method="post" class="d-inline">
										@method('delete')
										@csrf
										<button class="btn btn-danger btn-sm" id='deleteData' data-title="{{ $kota_kabupaten->nama }}">
