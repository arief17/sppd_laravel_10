	...
	<div class="col-lg-6 col-xl-6 col-md-12 col-sm-12">
		<div class="card box-shadow-0 ">
			...
			<div class="card-body pt-0">
				<form action="{{ route('ketentuan.index') }}" method="post">
					@csrf
					...
					<div class="form-group">
						...
						<select name="kegiatan" id="kegiatan" class="form-control form-select @error('kegiatan') is-invalid @enderror">
							...
							<option value="{{ $kegiatan->id }}" @selected(old('kegiatan') == $kegiatan->id)>
								{{ $kegiatan->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<input name="kode_rek_dalam_daerah" value="{{ old('kode_rek_dalam_daerah') }}" type="text" class="form-control @error('kode_rek_dalam_daerah') is-invalid @enderror" id="kode_rek_dalam_daerah" placeholder="Masukan kode_rek_dalam_daerah">
					...
					<div class="form-group">
						...
						<input name="kode_rek_luar_daerah" value="{{ old('kode_rek_luar_daerah') }}" type="text" class="form-control @error('kode_rek_luar_daerah') is-invalid @enderror" id="kode_rek_luar_daerah" placeholder="Masukan kode_rek_luar_daerah">
					...
					<div class="form-group">
						...
						<select name="pptk" id="pptk" class="form-control form-select @error('pptk') is-invalid @enderror">
							...
							<option value="{{ $pptk->id }}" @selected(old('pptk') == $pptk->id)>
								{{ $pptk->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="bendahara" id="bendahara" class="form-control form-select @error('bendahara') is-invalid @enderror">
							...
							<option value="{{ $bendahara->id }}" @selected(old('bendahara') == $bendahara->id)>
								{{ $bendahara->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="pelaksana_administrasi" id="pelaksana_administrasi" class="form-control form-select @error('pelaksana_administrasi') is-invalid @enderror">
							...
							<option value="{{ $pelaksana_administrasi->id }}" @selected(old('pelaksana_administrasi') == $pelaksana_administrasi->id)>
