				...
				<form action="{{ route('pegawai.show', $pegawai->slug) }}" method="post">
					...
					<div class="form-group">
						...
						<select name="eselon" id="eselon" class="form-control form-select @error('eselon') is-invalid @enderror">
							...
							<option value="{{ $eselon->id }}" @selected(old('eselon', $pegawai->eselon) == $eselon->id)>
								{{ $eselon->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="jabatan" id="jabatan" class="form-control form-select @error('jabatan') is-invalid @enderror">
							...
							<option value="{{ $jabatan->id }}" @selected(old('jabatan', $pegawai->jabatan) == $jabatan->id)>
								{{ $jabatan->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						<div class="form-check">
							<input class="form-check-input @error('pptk') is-invalid @enderror" type="checkbox" name="pptk" value="pptk" id="pptk" @checked(old('pptk', $pegawai->pptk))>
