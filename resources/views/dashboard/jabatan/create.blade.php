			...
			<div class="card-body pt-0">
				<form action="{{ route('jabatan.index') }}" method="post">
					...
					<div class="form-group">
						...
						<input name="jabatan_singkat" value="{{ old('jabatan_singkat') }}" type="text" class="form-control @error('jabatan_singkat') is-invalid @enderror" id="jabatan_singkat" placeholder="Masukan jabatan_singkat">
