				...
				<form action="{{ route('user.show', $user->slug) }}" method="post">
					...
					<div class="form-group">
						...
						<select name="level_admin" id="level_admin" class="form-control form-select @error('level_admin') is-invalid @enderror">
							...
							<option value="{{ $level_admin->id }}" @selected(old('level_admin', $user->level_admin) == $level_admin->id)>
								{{ $level_admin->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="seksi" id="seksi" class="form-control form-select @error('seksi') is-invalid @enderror">
							...
							<option value="{{ $seksi->id }}" @selected(old('seksi', $user->seksi) == $seksi->id)>
								{{ $seksi->nama }}
							</option>
							@endforeach
						</select>
					...
					<div class="form-group">
						...
						<select name="bidang" id="bidang" class="form-control form-select @error('bidang') is-invalid @enderror">
							...
							<option value="{{ $bidang->id }}" @selected(old('bidang', $user->bidang) == $bidang->id)>
								{{ $bidang->nama }}
							</option>
							@endforeach
						</select>
